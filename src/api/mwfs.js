(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.Wfs = f() } })(function () {
  var define, module, exports; return (function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
      ...
      var BufferController = function (_EventHandler) {
        ...
        _createClass(BufferController, [{
          ...
          value: function onMediaSourceOpen() {
            ...
            if (this.mediaType === 'FMp4') this.checkPendingTracks();
      ...
      var FlowController = function (_EventHandler) {
        ...
        _createClass(FlowController, [{
          ...
          value: function onMediaAttached(data) {
            console.log("553:连接到websocket: ")
            if (data.websocketName != undefined) {
              var serurl = 'ws://' + window.location.hostname + ':8866/live?index=' + data.channelName;
              var client = new WebSocket(serurl);
    ...
    4: [function (require, module, exports) {
      ...
      var ExpGolomb = function () {
        ...
        _createClass(ExpGolomb, [{
          ...
          /**
         *使ExpGolomb解码器前进经过缩放列表。缩放
         *列表可选择作为序列参数的一部分进行传输
         *设置并且与转化无关。
         *@param count｛number｝此缩放列表中的条目数
         *@参见建议ITU-T H.264，第7.3.2.1.1.1节
      ...
      *属性。序列参数集是H264元数据
      *描述了即将到来的视频帧的属性。
      *@param data｛Uint8Array｝序列参数集的字节
      *@return｛object｝从
      *序列参数集，包括
      *关联的视频帧。
           */
    ...
    //基于H264的解码器，实现了一个264Demuxer的类，解析之后将视频帧进行推送
    ...
    }, { "../event-handler": 7, "../events": 8, "../remux/mp4-remuxer": 13, "./exp-golomb": 4 }],
      ...
      var WebsocketLoader = function (_EventHandler) {
        ...
        _createClass(WebsocketLoader, [{
          ...
          value: function onWebsocketAttaching(data) {
            console.log("追加websocket数据信息： 1596")
            this.mediaType = data.mediaType;
            this.channelName = data.channelName;
          ...
          value: function initSocketClient(client) {
            ...
            console.log("准备接受到数据： receiveSocketMessage")
      ...
      var MP4 = function () {
        ...
        _createClass(MP4, null, [{
          ...
          value: function initSegment(tracks) {
            ...
            var movie = MP4.moov(tracks), result = null;
            //console.info(result)
    ...
    }, { "../errors": 6, "../events": 8, "../helper/aac": 9, "../remux/mp4-generator": 12, "../utils/logger": 15, "../utils/polyfill": 16 }],
